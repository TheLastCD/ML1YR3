...
for i in degs:
    ...
    # w1 = getWeightsForPolynomialFit(x_train,y_train,i)
    # print("hi")
    # Xtest1 = getPolynomialDataMatrix(x_test,i)
    # if i == 0:
    #     ytest1= Xtest1.dot(w1[0:6])
        
    # else:
    #     ytest1 = Xtest1.dot(w1)

    # print(eval_pol_regression(Xtest1, ytest1, y_test, i))
